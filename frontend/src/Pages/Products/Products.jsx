...
function ProductDetailPage() {
  ...
  const AddToWishlist = () => {
    addToWishlist({ productId: productId, color: "default", size: "default" });
  };
  ...
  const reviews = [
    {
      ...
      date: "2 months ago",
      comment:
        "These headphones are amazing! The sound quality is top-notch, and the noise cancellation is incredibly effective.",
    },
    {
      id: 2,
      name: "Ethan Bennett",
      ...
      date: "3 months ago",
      comment:
        "I'm really happy with these headphones. Clear sound, comfortable design, and great battery life.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => AddToCart()}
                className="flex-1 bg-indigo-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-indigo-700 transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-gray-200 text-gray-800 font-semibold py-3 px-6 rounded-lg hover:bg-gray-300 transition-colors flex items-center justify-center gap-2"
              >
